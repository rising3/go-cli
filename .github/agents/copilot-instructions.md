...
- Local filesystem (~/.config/mycli/*.yaml configuration files) (005-configure-refactor)
...
## Recent Changes
- 005-configure-refactor: Added Go 1.25.4 + Cobra v1.10.1, Viper v1.21.0, gopkg.in/yaml.v3 v3.0.1
